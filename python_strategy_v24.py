...
# Auto-generated by StrategyEvolver v24 (deterministic, no LLM)
# Optimisation note: Target: win rate 40.7% - trend filter needs rework; R:R 1.94 - TP too close or SL too near. Parameter changes:   fvg_atr_multi: 0.547 - 0.527   sl_atr_multi: 1.835 - 1.790   tp_atr_multi: 8.348 - 9.00

PARAMS = {
    "atr_period": 14,
    "fvg_atr_multi": 0.5274,
    "sl_atr_multi": 1.7903,
    "tp_atr_multi": 9.0,
