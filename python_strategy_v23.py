...
# Auto-generated by StrategyEvolver v23 (deterministic, no LLM)
# Optimisation note: Target: win rate 33.0% - trend filter needs rework; R:R 1.84 - TP too close or SL too near; PF 0.90 - losers > winners. Parameter changes:   sl_atr_multi: 2.000 - 1.835   tp_atr_multi: 5.000 - 8.348  

PARAMS = {
    "atr_period": 14,
    "fvg_atr_multi": 0.5466,
    "sl_atr_multi": 1.8352,
    "tp_atr_multi": 8.3475,
    "trail_atr_multi": 1.65,
    "sma_fast_period": 20,
    "sma_slow_period": 105,
    "cmf_period": 20,
    "cmf_threshold": 0.2285
}
